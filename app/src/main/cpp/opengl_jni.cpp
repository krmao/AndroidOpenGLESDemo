...
Java_com_codesdancing_android_opengles_other_utils_JniRendererUtil_surfaceCreated(JNIEnv *env, jobject thiz, jint type) {
    switch (type) {
        case 1:
...
Java_com_codesdancing_android_opengles_other_utils_JniRendererUtil_surfaceChanged(JNIEnv *env, jobject thiz, jint width,
                                                            jint height) {
    desWidth = width;
    desHeight = height;
    if (renderer != nullptr) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_codesdancing_android_opengles_other_utils_JniRendererUtil_drawFrame(JNIEnv *env, jobject thiz) {
    if (renderer != nullptr) {
